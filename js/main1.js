...
// console.log(typeof Number(notANumber));
// console.log(Number("popopopo"));
...
// Напиши скрипт, который выводит в консоль округленные вверх / вниз и т.д.значения переменной value.Используй методы Math.floor(), Math.ceil() и Math.round().
...
// const value = (undefined ?? null ?? incomingValue) || defaultValue;
// console.log(value);
...
// const houer = String(Math.floor(totalMinutes / 60));
// const minutes = String(totalMinutes % 60);

// const didgitHouer = houer.padStart(2, 0);
// const didgitMinuts = minutes.padStart(2, 0);

// console.log(`${didgitHouer}:${didgitMinuts}`);

// const totalMinutse = 1441;

// const houer = String(Math.floor(totalMinutse / 60));
// const minutse = String(Math.floor(totalMinutse % 60));
